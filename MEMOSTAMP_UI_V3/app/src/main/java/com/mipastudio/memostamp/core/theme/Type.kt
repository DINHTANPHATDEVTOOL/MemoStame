...
// Consumer-app UI: one clean sans family almost everywhere.
...
// Kept for compatibility with existing screens; intentionally points to the UI sans family.
val AppDisplayFontFamily = AppSansFontFamily

// Use serif only inside stamp/postcard artwork, never as general UI chrome.
val StampSerifFontFamily = FontFamily(
